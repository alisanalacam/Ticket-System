...
/**
 *
 * @author Alişan ALAÇAM<alisanalacam@.com>
 */
class UserServiceProvider implements ServiceProviderInterface
{
    ...
    public function register(Application $app)
    {
        ...
        $overrideAuthenticationProviders = $app['security.authentication_providers'];

        $app['security.authentication_manager'] = $app->share(function ($app) use ($overrideAuthenticationProviders) {

            $manager = new AuthenticationProviderManager($overrideAuthenticationProviders);
